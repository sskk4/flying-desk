...
const RoomRentalDetails = () => {
  ...
  useEffect(() => {
    const fetchRoomAndRentals = async () => {
      try {
        ...
        console.error("Error loading room or rental data:", err);
        setError("Unable to load room or rental data");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div>
        ...
        <div className="error-container">
          <div className="error-message">Error: {error || "Could not load room information"}</div>
      ...
      <div className="manage-ads-container">
        <div className="rental-details-header">
          <h2>
            ...
            <hr></hr>
            Rental History for <span className="owner-title">{room.room}</span>
          </h2>
        </div>
        ...
        <div className="rental-history-container">
          ...
          {rentalHistory.length > 0 ? (
            ...
            <div className="no-rentals-message">
              <p>No rental history available for this room.</p>
            </div>
          )}
        </div>
        <hr></hr>
...
export default RoomRentalDetails;